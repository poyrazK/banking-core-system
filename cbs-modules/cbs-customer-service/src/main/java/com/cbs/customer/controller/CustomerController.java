...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> updateCustomer(
        ...
        CustomerResponse customerResponse = customerService.updateCustomer(customerId, request);
        return ResponseEntity.ok(ApiResponse.success("Customer updated", customerResponse));
    }
}
